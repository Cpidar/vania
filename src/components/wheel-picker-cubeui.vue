...
$picker-bgc := $white
$picker-title-color := $grey-10
$picker-subtitle-color := $grey-4
$picker-confirm-btn-color := $orange
$picker-confirm-btn-active-color := $orange-4
$picker-cancel-btn-color := $grey-4
$picker-cancel-btn-active-color := $grey-4
$picker-item-color := $grey-10
